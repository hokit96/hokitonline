...
Partial Public Class DataSet2
    ...
    Partial Public Class paymentDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
        Public Overloads Function AddpaymentRow(ByVal CustomerID As Integer, ByVal mid As Integer, ByVal dateofentry As Date, ByVal loggedby As String, ByVal Description As String, ByVal amountdue As Decimal, ByVal amountpaid As Decimal, ByVal paymentdate As Date) As paymentRow
            Dim rowpaymentRow As paymentRow = CType(Me.NewRow, paymentRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, CustomerID, mid, dateofentry, loggedby, Description, amountdue, amountpaid, paymentdate}
    ...
    Partial Public Class paymentRow
        ...
        Public Property amountdue() As Decimal
            Get
                Try
                    Return CType(Me(Me.tablepayment.amountdueColumn), Decimal)
                Catch e As Global.System.InvalidCastException
    ...
    Partial Public Class paymentTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `payment` WHERE ((`PaymentID` = ?) AND ((? = 1 AND `CustomerID` IS NU" & _
                ...
                "scription` = ?)) AND ((? = 1 AND `amountdue` IS NULL) OR (`amountdue` = ?)) AND " & _
                "((? = 1 AND `amountpaid` IS NULL) OR (`amountpaid` = ?)) AND ((? = 1 AND `paymen" & _
                "tdate` IS NULL) OR (`paymentdate` = ?)))"
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_amountdue", Global.System.Data.OleDb.OleDbType.Currency, 0, Global.System.Data.ParameterDirection.Input, CType(0, Byte), CType(0, Byte), "amountdue", Global.System.Data.DataRowVersion.Original, False, Nothing))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `payment` (`CustomerID`, `mid`, `dateofentry`, `loggedby`, `Descripti" & _
                "on`, `amountdue`, `amountpaid`, `paymentdate`) VALUES (?, ?, ?, ?, ?, ?, ?, ?)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("amountdue", Global.System.Data.OleDb.OleDbType.Currency, 0, Global.System.Data.ParameterDirection.Input, CType(0, Byte), CType(0, Byte), "amountdue", Global.System.Data.DataRowVersion.Current, False, Nothing))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `payment` SET `CustomerID` = ?, `mid` = ?, `dateofentry` = ?, `loggedby` =" & _
                " ?, `Description` = ?, `amountdue` = ?, `amountpaid` = ?, `paymentdate` = ? WHER" & _
                "E ((`PaymentID` = ?) AND ((? = 1 AND `CustomerID` IS NULL) OR (`CustomerID` = ?)" & _
                ") AND ((? = 1 AND `mid` IS NULL) OR (`mid` = ?)) AND ((? = 1 AND `dateofentry` I" & _
                "S NULL) OR (`dateofentry` = ?)) AND ((? = 1 AND `loggedby` IS NULL) OR (`loggedb" & _
                "y` = ?)) AND ((? = 1 AND `Description` IS NULL) OR (`Description` = ?)) AND ((? " & _
                "= 1 AND `amountdue` IS NULL) OR (`amountdue` = ?)) AND ((? = 1 AND `amountpaid` " & _
                "IS NULL) OR (`amountpaid` = ?)) AND ((? = 1 AND `paymentdate` IS NULL) OR (`paym" & _
                "entdate` = ?)))"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("amountdue", Global.System.Data.OleDb.OleDbType.Currency, 0, Global.System.Data.ParameterDirection.Input, CType(0, Byte), CType(0, Byte), "amountdue", Global.System.Data.DataRowVersion.Current, False, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_amountdue", Global.System.Data.OleDb.OleDbType.Currency, 0, Global.System.Data.ParameterDirection.Input, CType(0, Byte), CType(0, Byte), "amountdue", Global.System.Data.DataRowVersion.Original, False, Nothing))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT PaymentID, CustomerID, mid, dateofentry, loggedby, Description, amountdue," & _
                " amountpaid, paymentdate FROM payment"
        ...
        Public Overridable Overloads Function Fill(ByVal dataTable As DataSet2.paymentDataTable) As Integer
        ...
        Public Overridable Overloads Function GetData() As DataSet2.paymentDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DataSet2.paymentDataTable = New DataSet2.paymentDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")> _
        Public Overridable Overloads Function Update(ByVal dataTable As DataSet2.paymentDataTable) As Integer
        ...
        Public Overridable Overloads Function Delete(ByVal Original_PaymentID As Integer, ByVal Original_CustomerID As Global.System.Nullable(Of Integer), ByVal Original_mid As Global.System.Nullable(Of Integer), ByVal Original_dateofentry As Global.System.Nullable(Of Date), ByVal Original_loggedby As String, ByVal Original_Description As String, ByVal Original_amountdue As Global.System.Nullable(Of Decimal), ByVal Original_amountpaid As Global.System.Nullable(Of Decimal), ByVal Original_paymentdate As Global.System.Nullable(Of Date)) As Integer
            ...
            If (Original_amountdue.HasValue = True) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(12).Value = CType(Original_amountdue.Value, Decimal)
            Else
            ...
            If (Original_amountpaid.HasValue = True) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(14).Value = CType(Original_amountpaid.Value, Decimal)
            Else
        ...
        Public Overridable Overloads Function Insert(ByVal CustomerID As Global.System.Nullable(Of Integer), ByVal mid As Global.System.Nullable(Of Integer), ByVal dateofentry As Global.System.Nullable(Of Date), ByVal loggedby As String, ByVal Description As String, ByVal amountdue As Global.System.Nullable(Of Decimal), ByVal amountpaid As Global.System.Nullable(Of Decimal), ByVal paymentdate As Global.System.Nullable(Of Date)) As Integer
            ...
            If (amountdue.HasValue = True) Then
                Me.Adapter.InsertCommand.Parameters(5).Value = CType(amountdue.Value, Decimal)
            Else
            ...
            If (paymentdate.HasValue = True) Then
                Me.Adapter.InsertCommand.Parameters(7).Value = CType(paymentdate.Value, Date)
            Else
        ...
        Public Overridable Overloads Function Update( _
            ...
            End If
            If (amountdue.HasValue = True) Then
                Me.Adapter.UpdateCommand.Parameters(5).Value = CType(amountdue.Value, Decimal)
            Else
                Me.Adapter.UpdateCommand.Parameters(5).Value = Global.System.DBNull.Value
            End If
            If (amountpaid.HasValue = True) Then
                Me.Adapter.UpdateCommand.Parameters(6).Value = CType(amountpaid.Value, Decimal)
            Else
                Me.Adapter.UpdateCommand.Parameters(6).Value = Global.System.DBNull.Value
            End If
            If (paymentdate.HasValue = True) Then
                Me.Adapter.UpdateCommand.Parameters(7).Value = CType(paymentdate.Value, Date)
            Else
            ...
            If (Original_mid.HasValue = True) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(12).Value = CType(Original_mid.Value, Integer)
            Else
            ...
            If (Original_dateofentry.HasValue = True) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(14).Value = CType(Original_dateofentry.Value, Date)
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(16).Value = CType(Original_loggedby, String)
            End If
            If (Original_Description Is Nothing) Then
            ...
            If (Original_amountdue.HasValue = True) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(20).Value = CType(Original_amountdue.Value, Decimal)
            Else
            ...
            If (Original_amountpaid.HasValue = True) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(22).Value = CType(Original_amountpaid.Value, Decimal)
            Else
            ...
            If (Original_paymentdate.HasValue = True) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(24).Value = CType(Original_paymentdate.Value, Date)
            Else
